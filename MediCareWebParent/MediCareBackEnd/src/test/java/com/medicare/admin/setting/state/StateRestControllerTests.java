package com.medicare.admin.setting.state;
...
import com.medicare.admin.setting.country.CountryRepository;
...
public class StateRestControllerTests {
	...
	@Test
	@WithMockUser(username = "abhinav", password = "something", roles = "Admin")
	...
	public void testCreateState() throws Exception {
		...
		State state = new State("Karnataka", country);
	...
	@Test
	@WithMockUser(username = "bhardwaj.abhi58@gmail.com", password = "something", roles = "Admin")
